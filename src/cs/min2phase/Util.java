...
final class Util {
	...
	final static byte[][] cornerFacelet = { { U9, R1, F3 }, { U7, F1, L3 },
			{ U1, L1, B3 }, { U3, B1, R3 }, { D3, F9, R7 }, { D1, L9, F7 },
			{ D7, B9, L7 }, { D9, R9, B7 } };
	final static byte[][] edgeFacelet = { { U6, R2 }, { U8, F2 }, { U4, L2 },
			{ U2, B2 }, { D6, R8 }, { D2, F8 }, { D4, L8 }, { D8, B8 },
			{ F6, R4 }, { F4, L6 }, { B6, L4 }, { B4, R6 } };
	final static byte[][] cornerColor = { { U, R, F }, { U, F, L },
			{ U, L, B }, { U, B, R }, { D, F, R }, { D, L, F }, { D, B, L },
			{ D, R, B } };
	final static byte[][] edgeColor = { { U, R }, { U, F }, { U, L }, { U, B },
			{ D, R }, { D, F }, { D, L }, { D, B }, { F, R }, { F, L },
			{ B, L }, { B, R } };
	...
	static CubieCube toCubieCube(byte[] f) {
		...
		for (byte i = 0; i < 8; i++) {
			...
			for (ori = 0; ori < 3; ori++)
				if (f[cornerFacelet[i][ori]] == U
						|| f[cornerFacelet[i][ori]] == D)
					break;
	...
	/*
	 * final static int bitCount8(int i) { i = i - ((i >>> 1) & 0x55555555); i =
	 * (i & 0x33333333) + ((i >>> 2) & 0x33333333); return (i + (i >>> 4)) &
	 * 0x0f; }
	 */
	...
	static String[] move2str = { "U", "U2", "U'", "R", "R2", "R'", "F", "F2",
			"F'", "D", "D2", "D'", "L", "L2", "L'", "B", "B2", "B'" };
	...
	static byte[][] perm3 = { { 11, 10, 9 }, { 10, 11, 9 }, { 11, 9, 10 },
			{ 9, 11, 10 }, { 10, 9, 11 }, { 9, 10, 11 } };
